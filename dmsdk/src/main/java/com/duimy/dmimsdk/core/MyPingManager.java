...
public class MyPingManager extends Manager {
    ...
    /**
     * Retrieves a {@link MyPingManager} for the specified {@link XMPPConnection}, creating one if it doesn't already
     * exist.
     * 
     * @param connection
    ...
    /**
     * The default ping interval in seconds used by new MyPingManager instances. The default is 30 minutes.
     */

package com.example.dmmonerylibrary.network;


import com.example.dmmonerylibrary.network.api.MoneryApi;
...
public class HttpCall {
    ...
    public MoneryApi getAPI() {
        return mRetrofit.create(MoneryApi.class);
    }
